...
var isIphoneX = platform === "ios" && (deviceHeight === 812 || deviceWidth === 812);
exports.default = {
    ...
    brandPrimary: platform === "ios" ? "#dc7039" : "#dc7039",
    brandInfo: "#62B1F6",
    brandSuccess: "#5cb85c",
    brandDanger: "#d9534f",
    brandWarning: "#f0ad4e",
    ...
    tabBarTextColor: platform === "ios" ? "#eee" : "#eee",
    // tabBarTextColor: platform === "ios" ? "#737373" : "#bfc6ea",
    tabBarTextSize: platform === "ios" ? 14 : 11,
    activeTab: platform === "ios" ? "#007aff" : "#fff",
    sTabBarActiveTextColor: "#007aff",
    // sTabBarActiveTextColor: "#eee",
    ...
    Inset: {
        portrait: {topInset: 24, leftInset: 0, rightInset: 0, bottomInset: 34},
        landscape: {topInset: 0, leftInset: 44, rightInset: 44, bottomInset: 21}
    }
};
